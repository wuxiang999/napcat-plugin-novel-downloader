...
### ✨ 新增功能
- **链接识别** - 支持自动识别七猫小说链接
  - 支持格式：`https://www.qimao.com/shuku/1879266/`
  - 支持格式：`https://qimao.com/shuku/1879266/`
  - 支持格式：`https://wtzw.com/shuku/1879266/`
  - 自动提取书籍ID并开始下载
  - 无需手动输入ID，直接分享链接即可

### 🔧 改进
- 添加链接提取工具模块 `src/utils/link-extractor.ts`
- 优化消息处理流程，优先检查链接
- 增强用户体验，支持多种链接格式

### 📝 使用示例
```
用户分享链接: https://www.qimao.com/shuku/1879266/
机器人自动识别并下载该小说
```
